...
type AdminUsersRemoveSecurity struct {
	SlackAuth string `security:"scheme,type=oauth2,name=Authorization"`
}

type AdminUsersRemoveApplicationJSON struct {
...
type AdminUsersRemoveRequest struct {
	RequestBody AdminUsersRemoveApplicationJSON `request:"mediaType=application/json"`
