...
type AdminInviteRequestsApproveSecurity struct {
	SlackAuth string `security:"scheme,type=oauth2,name=Authorization"`
}

type AdminInviteRequestsApproveApplicationJSON struct {
...
type AdminInviteRequestsApproveRequest struct {
	RequestBody AdminInviteRequestsApproveApplicationJSON `request:"mediaType=application/json"`
